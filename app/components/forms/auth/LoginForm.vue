  ...
  <div class="flex flex-col gap-6">
    <div class="flex flex-col gap-6">
      <div class="flex flex-col items-center gap-2">
        ...
        <div class="text-center text-sm">Login with your Apple or Google account</div>
      </div>
      <form @submit.prevent="login">
        <div class="grid gap-6">
          <div class="flex flex-col gap-4">
            <Button type="button" variant="outline" class="w-full" @click="openInPopup('/auth/github')">
          ...
          <div class="grid gap-6">
            ...
            <Button type="submit" class="w-full" :disabled="credentials.processing">
              <LoaderCircle v-if="credentials.processing" class="h-4 w-4 animate-spin" />
              Login
            </Button>
          </div>
